...
class Map extends React.Component {
  ...
  componentDidUpdate({ markersData }) {
    console.log("2-");
    console.log("2-" + markersData.length);
  ...
  updateMarkers(markersData) {
    console.log("3-");
    console.log("3-" + markersData.length);
    ...
    markersData.forEach(marker => {
      L.marker(marker.latLng, { title: marker.title, icon: defaultIcon }).addTo(this.layer).on('click', function(e) {
        console.log(marker.region);
        console.log(marker.risk);
    });
